...
describe('IdeaService', () => {
  ...
  it('should create an idea (POST)', () => {
    ...
    const createdIdea: Idea = { id: '3', title: 'New Idea', description: 'New Desc', status: 'RESEARCHING', createdAt: '', updatedAt: '' };
  ...
  it('should update an idea (PUT)', () => {
    ...
    const updatedIdea: Idea = { id: '1', title: 'Updated Title', description: 'Desc 1', status: 'RESEARCHING', createdAt: '', updatedAt: '' };
